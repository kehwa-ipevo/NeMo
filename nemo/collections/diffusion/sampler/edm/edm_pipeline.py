...
class EDMPipeline:
    ...
    Attributes:
        ...
        condition_keys: Keys for conditioning data.
    Methods:
    ...
    def __init__(
        ...
        Attributes:
            ...
            condition_keys (list): List of condition keys.
        """
        self.vae = vae
        self.net = net
        ...
        self.condition_keys = ['fps', 't5_text_embeddings', 't5_text_mask']
    ...
    def compute_loss_with_epsilon_and_sigma(
        ...
        if parallel_state.is_pipeline_last_stage():
            ...
            edm_loss = rearrange(edm_loss, "b c t h w -> b c (t h w)", b=b, c=c, t=t, h=h, w=w)
    ...
    def generate_samples_from_batch(
        ...
        x_sigma_max = (
            torch.randn(1, *state_shape, **self.tensor_kwargs, generator=self._noise_generator) * self.sde.sigma_max
        )
    ...
    def get_data_and_condition(self, data_batch: dict[str, Tensor], dropout_rate=0.2) -> Tuple[Tensor]:
        ...
        # Condition
        condition = {'fps': data_batch['fps'],
                     'crossattn_emb': data_batch['t5_text_embeddings'],
                     'crossattn_mask': data_batch['t5_text_mask']
                    }
        condition['crossattn_emb'] = self.random_dropout_input(condition['crossattn_emb'], dropout_rate=dropout_rate)
