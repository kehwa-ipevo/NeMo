...
class AdaLN(MegatronModule):
    ...
    """
    def __init__(self, config: TransformerConfig, n_adaln_chunks=9):
...
class DiTLayerWithAdaLN(TransformerLayer):
    ...
    def forward(
        ...
        if self.cross_attention:
            shift_full, scale_full, gate_full, shift_ca, scale_ca, gate_ca, shift_mlp, scale_mlp, gate_mlp = self.adaLN(timestep_emb)
        else:
        ...
        # print(f"mcore_dit_fa_out={attention_output}")
