...
from megatron.energon import DefaultTaskEncoder, SkipSample, Sample
...
class BasicDiffusionTaskEncoder(DefaultTaskEncoder, IOMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.aethetic_score = aethetic_score
    ...
    def encode_sample(self, sample: dict) -> dict:
        ...
        info = sample['json']
        if info['aesthetic_score'] < self.aethetic_score:
            raise SkipSample()
